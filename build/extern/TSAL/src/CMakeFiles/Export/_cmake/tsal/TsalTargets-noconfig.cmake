...
set_target_properties(tsal::tsal PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libtsal.so"
  IMPORTED_SONAME_NOCONFIG "libtsal.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS tsal::tsal )
list(APPEND _IMPORT_CHECK_FILES_FOR_tsal::tsal "${_IMPORT_PREFIX}/lib/libtsal.so" )
...
set_target_properties(tsal::midifile PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libmidifile.so"
  IMPORTED_SONAME_NOCONFIG "libmidifile.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS tsal::midifile )
list(APPEND _IMPORT_CHECK_FILES_FOR_tsal::midifile "${_IMPORT_PREFIX}/lib/libmidifile.so" )
