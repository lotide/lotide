...
// Detects file type
int FileOperations::load(std::string filePath) {
    // Extract
...
// take
// Test if file extension is correct
// TODO Detect file type and load accordingly
// Detects modified file through message passing
int FileOperations::save(std::string filePath) {
